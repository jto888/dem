...
#include "MaintList.h"
 ...
 SEXP demwActionswMaint(SEXP model_in, SEXP years_in, SEXP actions_in, SEXP maint_in, SEXP margin_in) {       
...
// the Act object adds DirectImpact action info to appropriate oplines
// holding a persistent copy of the action_rows matrix
...
// before moving the pos index, set the last duration	
	...
	outlist.push_back(Act->getActionRows());
/*	
/home/dad/R/x86_64-pc-linux-gnu-library/4.0/Rcpp/include/Rcpp/internal/wrap.h:523:31: 
* error: static assertion failed: cannot convert type to SEXP
  523 |    static_assert(!sizeof(T), "cannot convert type to SEXP")	
	
	outlist.push_back(Rcpp::wrap(OLL->getByNum(7)->getDirectImpacts()[1]));	
// would need to read the direct impacts into another container
// Rcpp::wrap knows nothing about DirectImpact objects
*/
