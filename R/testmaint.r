testmaint<-function(Model,OpLineNames=NULL,SimulationYears = 10,SimulationYearsPerPage = 10, Dep=NULL, Maint=NULL,				
...
## opline size vector to be added to StackedModel on each pass of pages				
	...
	if(!is.null(Maint)) {			
		 ## this is the old call to an unregistered C++ code in the dem library		
